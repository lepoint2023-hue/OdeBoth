/* ═══════════════════════════════════════════════════════════
   MODULE 6 — APPEL API GROQ
   Commune de Sainte-Ode · v3.0
   ═══════════════════════════════════════════════════════════

   INSTRUCTIONS :
   Remplacez VOTRE_CLE_ICI par votre clé API Groq
   (celle qui commence par gsk_...)
  ...
  try {
    const response = await fetch(API_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: buildPrompt(getSelectedSvc(), lang) },
          ...history
        ],
