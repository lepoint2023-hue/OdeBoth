...
let exhaustedUntil  = 0; // timestamp — les deux providers sont épuisés jusqu'à cette heure
...
async function callGemini(userMessage) {
  ...
  try {
    ...
    addMsg("bot", isTimeout ? MSG_TIMEOUT[lang] : MSG_CONNEXION[lang]);
  }
